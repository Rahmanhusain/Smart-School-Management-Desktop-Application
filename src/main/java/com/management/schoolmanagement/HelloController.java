...
public class HelloController implements Initializable {
    ...
    protected void Teachers() throws IOException {
        Stage newWindow = new Stage();
        newWindow.setTitle("Teachers");
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("Teachers.fxml"));
        newWindow.getIcons().add(new Image(Objects.requireNonNull(HelloApplication.class.getResource("styles/slogo.png")).openStream()));
        newWindow.setScene(new Scene(loader.load()));
        newWindow.show();
    }
    ...
    void Science() throws IOException {
        Stage newWindow = new Stage();
        newWindow.setTitle("Science Lab");
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("ScienceLab.fxml"));
        newWindow.getIcons().add(new Image(Objects.requireNonNull(HelloApplication.class.getResource("styles/slogo.png")).openStream()));
        newWindow.setScene(new Scene(loader.load()));
        newWindow.show();
    }
    ...
    void Computer() throws IOException {
        Stage newWindow = new Stage();
        newWindow.setTitle("Computer Lab");
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("ComputerLab.fxml"));
        newWindow.getIcons().add(new Image(Objects.requireNonNull(HelloApplication.class.getResource("styles/slogo.png")).openStream()));
        newWindow.setScene(new Scene(loader.load()));
        newWindow.show();
    }
    ...
    void Library() throws IOException {
        Stage newWindow = new Stage();
        newWindow.setTitle("Library");
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("Library.fxml"));
        newWindow.getIcons().add(new Image(Objects.requireNonNull(HelloApplication.class.getResource("styles/slogo.png")).openStream()));
        newWindow.setScene(new Scene(loader.load()));
        newWindow.show();
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            this.student.setText(String.valueOf(this.c.studentcount()));
            this.user.setText(String.valueOf(this.c.usercount()));
            this.Techers.setText(String.valueOf(this.c.teachercount()));
