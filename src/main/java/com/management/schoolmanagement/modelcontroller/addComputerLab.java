...
public class addComputerLab implements Initializable {
    ...
    public addComputerLab() {
    }

    @FXML
    void addComputer() {
        try {
            this.con.InsertComputer(Long.parseLong(this.id.getText()), this.Name.getText(), this.status.getText());
